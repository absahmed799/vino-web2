        ...
        <div class="bouteille" data-quantite="">
            ...
            <div class="footer-card">
                <div class="options" data-id="<?php echo $bouteille['id_bouteille_cellier'] ?>">
                    ...
                    <button class='btn btnAjouter btnCustom' data-id="<?php echo $bouteille['id_bouteille_cellier'] ?>" onclick="ajouterBouteilleQt(this)">+ Ajouter</button>
                    <button class='btn btnBoire' data-id="<?php echo $bouteille['id_bouteille_cellier'] ?>" onclick="boireBouteilleQt(this)">- Boire</button>
